...
# ============================================================
# [改进1] 多层注意力 Rollout 开关
# 设为 True 启用多层注意力聚合, False 则回退到原版单层行为
# ============================================================
USE_MULTI_LAYER = True
MULTI_LAYER_SELECTION = [15]  # Qwen2.5-VL 7B 推荐层范围 14~17
# ============================================================
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        for decoder_layer in self.layers:
            layernums+=1
            # ============================================================
            # [改进1] 多层注意力 Rollout: 当 USE_MULTI_LAYER=True 时,
            # 对 MULTI_LAYER_SELECTION 中的所有层计算注意力
            # 原版: 仅 SELECT_LAYER=[15] 单层
            # ============================================================
            if USE_ALLATT and ori_output_attentions:
                output_attentions = True
            elif USE_MULTI_LAYER and ori_output_attentions:
                # [改进1] 多层模式: 使用 MULTI_LAYER_SELECTION
                if layernums in MULTI_LAYER_SELECTION:
                    output_attentions = True
                else:
                    output_attentions = False
            else:
