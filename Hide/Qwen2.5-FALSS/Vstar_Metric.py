...
#print(calculate_category_accuracy(read_multi_line_json_objects(r"hr_bench_4k_results.json")).T)
#print(calculate_category_accuracy(read_multi_line_json_objects(r"hr_bench_8k_results.json")).T)
